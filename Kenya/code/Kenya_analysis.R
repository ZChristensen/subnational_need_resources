...
MPIsubnational2$Population.size.by...region=MPIsubnational2$share.of.pop*MPIsubnational2$Population.2016
fwrite(MPIsubnational2,"input/Kenya_MPI_country.csv")

funding=read.xlsx("input/Kenya_Health_budget_per_capita_by_county.xlsx", sheet="Kenya county spending by region",startRow=2)
funding=funding[1:47,]
